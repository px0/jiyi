...
var x__19777__auto__ = (((this$ == null))?null:this$);
var m__19778__auto__ = (alandipert.storage_atom._get[goog.typeOf(x__19777__auto__)]);
if(!((m__19778__auto__ == null))){
return m__19778__auto__.call(null,this$,not_found);
} else {
var m__19778__auto____$1 = (alandipert.storage_atom._get["_"]);
if(!((m__19778__auto____$1 == null))){
return m__19778__auto____$1.call(null,this$,not_found);
} else {
...
var x__19777__auto__ = (((this$ == null))?null:this$);
var m__19778__auto__ = (alandipert.storage_atom._commit_BANG_[goog.typeOf(x__19777__auto__)]);
if(!((m__19778__auto__ == null))){
return m__19778__auto__.call(null,this$,value);
} else {
var m__19778__auto____$1 = (alandipert.storage_atom._commit_BANG_["_"]);
if(!((m__19778__auto____$1 == null))){
return m__19778__auto____$1.call(null,this$,value);
} else {
...
alandipert.storage_atom.StorageBackend.cljs$lang$ctorPrWriter = (function (this__19720__auto__,writer__19721__auto__,opt__19722__auto__){
return cljs.core._write.call(null,writer__19721__auto__,"alandipert.storage-atom/StorageBackend");
});
...
var G__49039 = atom;
cljs.core.add_watch.call(null,G__49039,new cljs.core.Keyword("alandipert.storage-atom","storage-watch","alandipert.storage-atom/storage-watch",1159565749),((function (G__49039,existing,debounce){
return (function (p1__49036_SHARP_,p2__49037_SHARP_,p3__49034_SHARP_,p4__49035_SHARP_){
if(cljs.core.truth_((function (){var and__19110__auto__ = alandipert.storage_atom._STAR_watch_active_STAR_;
if(cljs.core.truth_(and__19110__auto__)){
return cljs.core.not_EQ_.call(null,p3__49034_SHARP_,p4__49035_SHARP_);
} else {
return and__19110__auto__;
}
})())){
return debounce.call(null,((function (G__49039,existing,debounce){
return (function (){
return alandipert.storage_atom._commit_BANG_.call(null,backend,p4__49035_SHARP_);
});})(G__49039,existing,debounce))
,(function (){var or__19122__auto__ = alandipert.storage_atom._STAR_storage_delay_STAR_;
if(cljs.core.truth_(or__19122__auto__)){
return or__19122__auto__;
} else {
...
var _STAR_watch_active_STAR_49042 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;

try{return cljs.core.reset_BANG_.call(null,atom,default$);
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_49042;
}} else {
...
var _STAR_watch_active_STAR_49043 = alandipert.storage_atom._STAR_watch_active_STAR_;
alandipert.storage_atom._STAR_watch_active_STAR_ = false;
...
}finally {alandipert.storage_atom._STAR_watch_active_STAR_ = _STAR_watch_active_STAR_49043;
}} else {
return null;
}
} else {
...
return alandipert.storage_atom.maybe_update_backend.call(null,atom,storage,k,default$,p1__49044_SHARP_);
});})(default$))
);
});
/**
