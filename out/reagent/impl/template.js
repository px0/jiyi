...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19718__auto__,writer__19719__auto__,opt__19720__auto__){
return cljs.core._write.call(null,writer__19719__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__19120__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__19120__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__19120__auto__)){
return or__19120__auto__;
} else {
...
var G__47064 = o;
(G__47064[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__47065__delegate = function (args){
...
while (G__47066__i < G__47066__a.length) {G__47066__a[G__47066__i] = arguments[G__47066__i + 0]; ++G__47066__i;}
  args = new cljs.core.IndexedSeq(G__47066__a,0);
} 
...
var args = cljs.core.seq(arglist__47067);
...
var old_47068 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_47068))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_47068)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__19108__auto__ = (node === document.activeElement);
if(and__19108__auto__){
var and__19108__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__19108__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__47071 = jsprops;
(G__47071["defaultValue"] = value);

(G__47071["onChange"] = ((function (G__47071,v,value,on_change){
return (function (p1__47069_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__47069_SHARP_);
});})(G__47071,v,value,on_change))
);
...
var vec__47073 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__47073,(0),null);
var id = cljs.core.nth.call(null,vec__47073,(1),null);
var class$ = cljs.core.nth.call(null,vec__47073,(2),null);
...
var temp__4427__auto__ = (function (){var G__47077 = cljs.core.meta.call(null,v);
var G__47077__$1 = (((G__47077 == null))?null:reagent.impl.template.get_key.call(null,G__47077));
return G__47077__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__47079_47080 = v;
var G__47079_47081__$1 = (((G__47079_47080 == null))?null:reagent.impl.template.key_from_vec.call(null,G__47079_47080));
var G__47079_47082__$2 = (((G__47079_47081__$1 == null))?null:(jsprops["key"] = G__47079_47081__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__47085 = cljs.core.meta.call(null,argv);
var G__47085__$1 = (((G__47085 == null))?null:reagent.impl.template.get_key.call(null,G__47085));
return G__47085__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__47086 = (((jsprops == null))?{}:jsprops);
(G__47086["key"] = key);
...
var G__47087 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__47087;
continue;
}
} else {
...
var n__20023__auto___47088 = a.length;
var i_47089 = (0);
while(true){
if((i_47089 < n__20023__auto___47088)){
(a[i_47089] = reagent.impl.template.as_element.call(null,(a[i_47089])));

var G__47090 = (i_47089 + (1));
i_47089 = G__47090;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__20023__auto___47091 = a.length;
var i_47092 = (0);
while(true){
if((i_47092 < n__20023__auto___47091)){
var val_47093 = (a[i_47092]);
if((cljs.core.vector_QMARK_.call(null,val_47093)) && ((reagent.impl.template.key_from_vec.call(null,val_47093) == null))){
(o["no-key"] = true);
} else {
}

(a[i_47092] = reagent.impl.template.as_element.call(null,val_47093));

var G__47094 = (i_47092 + (1));
i_47092 = G__47094;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__19108__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__19108__auto__){
return (ctx["no-key"]);
} else {
return and__19108__auto__;
...
var G__47096 = (cljs.core.count.call(null,argv) - first_child);
switch (G__47096) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__47096){
